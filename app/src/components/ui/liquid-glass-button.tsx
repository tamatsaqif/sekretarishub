...
function LiquidButton({
  ...
  return (
    <Comp
      data-slot="button"
      className={cn(
        "relative isolate inline-flex items-center justify-center overflow-hidden rounded-full border border-white/65 px-10 py-3 text-[27px] font-medium leading-none tracking-[-0.04em] text-white shadow-[0_12px_28px_rgba(0,0,0,0.22),inset_2px_2px_5px_rgba(255,255,255,0.72),inset_-3px_-4px_8px_rgba(0,0,0,0.18)] transition-transform duration-200 hover:-translate-y-0.5 active:translate-y-0.5",
        liquidbuttonVariants({ variant, size }),
        className,
      )}
      style={{
        background:
          "linear-gradient(135deg, rgba(255,255,255,0.38), rgba(255,255,255,0.11) 48%, rgba(255,255,255,0.22))",
      ...
      {...props}
    >
      <span className="pointer-events-none absolute inset-[2px] rounded-full border border-white/45 bg-[linear-gradient(180deg,rgba(255,255,255,0.18),rgba(255,255,255,0.02))]" />
      <span className="pointer-events-none absolute inset-x-[8%] top-[6%] h-[38%] rounded-full bg-[radial-gradient(circle_at_20%_20%,rgba(255,255,255,0.82),rgba(255,255,255,0.2)_28%,transparent_64%)]" />
      <span className="pointer-events-none absolute inset-0 rounded-full bg-[radial-gradient(circle_at_28%_22%,rgba(255,255,255,0.3),transparent_43%)]" />
      <span className="relative z-10 drop-shadow-[0_1px_0_rgba(255,255,255,0.8)]">{children}</span>
    </Comp>
  )
}
